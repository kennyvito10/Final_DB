...
if (isset($_POST['addbutton'])) {
  ...
  $itemname = mysqli_real_escape_string($connection, $_POST['pname']);
  $itemprice = mysqli_real_escape_string($connection, $_POST['prices']);
    ...
    <div class="row" style="padding: 30px 300px">
      <div class="col-md-8">
        <table class="table">
          ...
          <tbody>
            <?php  
          if (mysqli_num_rows($queryGetProducts) > 0) { 
          ...
          ?>
            <tr>
              ...
              <td style="width: 100px">
                <a href="action/delete_package.php?productID= <?php echo $row["productID"] ?>">
        ...
        <div class="col-md-4" style="background-color: white;padding: 20px;height: 200px;outline: solid black 1px !important">
          <form action="" method="post">
            <div class="form-group">
              <input type="text" name="pname" class="form-control" id="exampleInputEmail1" placeholder="Enter Name">
            </div>
            <div class="form-group">
              <input type="text" name="prices" class="form-control" id="exampleInputEmail1" placeholder="Enter Price">
            </div>
